...
def home(request):
    ...
    # Adds content for form to page
    return render(request, 'checkbook/index.html', content)


# This function will render the Create New Account page when request
...
# This function will render the Transcation page when requested
